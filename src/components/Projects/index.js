              ...
              <div className="row">
                <div className="col">
                  <p className="project-p">
                    ...
                    features a custom layout provided by the client, offering a
                    modern design, improved user experience, and additional
                    features.
                  </p>
                </div>
              </div>
              ...
              <div className="row">
                <div className="col">
                  <p className="project-p">
                    ...
                    layout that can be used for job applications or other business
                    purposes.
                  </p>
                </div>
              </div>
