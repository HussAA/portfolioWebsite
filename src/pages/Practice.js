...
const Practice = () => {
  ...
  return (
    <>
      ...
      <h1 className={slide && "fade-in"}>{slide && <p>Hussain</p>}</h1>
      <h1 className={secSlide && "fade-in"}>{secSlide && <p>Ali</p>}</h1>
      <h1 className={thirdSlide && "fade-in"}>{thirdSlide && <p>Alnakhli</p>}</h1>
    </>
  );
};
